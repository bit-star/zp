...
import { SwComponent } from 'app/entities/sw/sw.component';
import { SwService } from 'app/entities/sw/sw.service';
import { Sw } from 'app/shared/model/sw.model';

describe('Component Tests', () => {
  describe('Sw Management Component', () => {
    let comp: SwComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sws[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
