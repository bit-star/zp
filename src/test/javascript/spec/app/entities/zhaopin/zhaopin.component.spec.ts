...
import { ZhaopinComponent } from 'app/entities/zhaopin/zhaopin.component';
import { ZhaopinService } from 'app/entities/zhaopin/zhaopin.service';
import { Zhaopin } from 'app/shared/model/zhaopin.model';

describe('Component Tests', () => {
  describe('Zhaopin Management Component', () => {
    let comp: ZhaopinComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ZhaopinComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.zhaopins[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
